...
const replacements = [
  ...
  ['You have been verified & given the', 'Du wurdest verifiziert und hast die'],
  ['You have been verified and received the', 'Du wurdest verifiziert und hast die'],
  ['You have successfully been verified', 'Du wurdest erfolgreich verifiziert'],
  ['You have been verified.', 'Du wurdest verifiziert.'],
  ['You are now verified.', 'Du bist jetzt verifiziert.'],
  ...
  ['Auto-verification', 'Auto-Verifizierung'],
  ['You must verify yourself to get the', 'Du musst dich verifizieren, um die'],
  ['role.', 'Rolle zu bekommen.'],
...
console.log('Hinweis: Discord-eigene UI-Texte lassen sich damit nicht ändern.');

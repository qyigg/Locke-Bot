...
export default {
    data: new SlashCommandBuilder()
        .setName('balance')
        .setDescription("Überprüfe deine oder jemand anderen seinen Kontostand")
        .addUserOption(option =>
            option
                .setName('user')
                .setDescription('Benutzer, dessen Kontostand überprüft werden soll')
                .setRequired(false)
        ),
    ...
    execute: withErrorHandling(async (interaction, config, client) => {
        ...
        if (targetUser.bot) {
            throw createError(
                ...
                "Bots haben keine Wirtschaftsbilanz\."
            );
        }
        ...
        if (!userData) {
            throw createError(
                ...
                ErrorTypes.DATABASE,
                "Fehler beim Laden der Wirtschaftsdaten\. Bitte versuche es später erneut\.",
        ...
        const bank = typeof userData.bank === 'number' ? userData.bank : 0;
            ...
            const embed = createEmbed({
                ...
                description: `Hier ist der aktuelle Finanzstatus für ${targetUser.username}.`,
            })
                .addFields(
                    {
                        name: "💵 Bargeld",
